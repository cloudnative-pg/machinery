...
// Info represents the parsed output of pg_controldata
type Info map[pgControlDataKey]string

// GetLatestCheckpointTimelineID returns the latest checkpoint's TimeLineID
func (p Info) GetLatestCheckpointTimelineID() string {
...
func (p Info) GetDatabaseClusterState() string {
...
func (p Info) GetDataPageChecksumVersion() (string, error) {
...
func (p Info) GetBytesPerWALSegment() (int, error) {
...
// ParseOutput parses a pg_controldata output into a map of key-value pairs
func ParseOutput(data string) Info {
